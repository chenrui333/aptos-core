...
impl Default for DynamicPrefetchingConfig {
    fn default() -> Self {
        Self {
            ...
            max_in_flight_subscription_requests: 10, // At ~4 blocks per second, this should last ~2.5 seconds
...
impl Default for AptosDataClientConfig {
    fn default() -> Self {
        Self {
            ...
            max_optimistic_fetch_lag_secs: 15, // 15 seconds
            max_response_timeout_ms: 60_000,   // 60 seconds
            max_state_chunk_size: MAX_STATE_CHUNK_SIZE,
            max_subscription_lag_secs: 15, // 15 seconds
